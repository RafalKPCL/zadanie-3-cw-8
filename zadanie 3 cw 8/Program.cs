    ...
    internal class zadanie3
    {
        ...
        class Program
        {
            static void Main()
            {
                ...
                WypelnijPrzedmiot(ref przedmioty[0], 1.5f, 10, "drewniana tarcza", KlasaRzadkosci.Rzadki, TypPrzedmiotu.Tarcza);
                WypelnijPrzedmiot(ref przedmioty[1], 1.5f, 10, "lekka tarcza", KlasaRzadkosci.Rzadki, TypPrzedmiotu.Tarcza);
                WypelnijPrzedmiot(ref przedmioty[2], 1.5f, 10, "Tarcza strażnika khorinis", KlasaRzadkosci.Rzadki, TypPrzedmiotu.Tarcza);
